...
NOTEBOOK_SWITCHES_FOR_BLACK ?=## Custom switches added to black for notebooks

PYTHON_SWITCHES_FOR_ISORT ?=## Custom switches added to isort

NOTEBOOK_SWITCHES_FOR_ISORT ?=## Custom switches added to isort for notebooks
...
##       PYTHON_SWITCHES_FOR_ISORT=<additional switches to pass to isort>
##       PYTHON_SWITCHES_FOR_BLACK=<additional switch to pass to black>
##       NOTEBOOK_SWITCHES_FOR_ISORT=<additional switch to pass to isort for notebooks>
##       NOTEBOOK_SWITCHES_FOR_BLACK=<additional switch to pass to black for notebooks>
##
...
notebook-do-lint:
	@mkdir -p build/reports;
	$(PYTHON_RUNNER) nbqa isort --check-only --profile=black --line-length=$(PYTHON_LINE_LENGTH) $(PYTHON_SWITCHES_FOR_ISORT) $(NOTEBOOK_SWITCHES_FOR_ISORT) $(NOTEBOOK_LINT_TARGET)
	$(PYTHON_RUNNER) nbqa black --check --line-length=$(PYTHON_LINE_LENGTH) $(PYTHON_SWITCHES_FOR_BLACK) $(NOTEBOOK_SWITCHES_FOR_BLACK) $(NOTEBOOK_LINT_TARGET)
